...
def pack(tmp_dir, project_name, config):
  shutil.make_archive("%s %s" % (project_name, config["version"]), "zip", tmp_dir)
...
def build(project_dir):
  ...
  crafts.gen(project_name, receipes, func_dir)
  pack(tmp_dir, project_name, config)
